...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<DXApplication_WF_XAFBlazorApplication>();
            builder.Modules
                ...
                .AddViewVariants()
                .Add<DXApplication_WF_XAF.Module.DXApplication_WF_XAFModule>()
            	.Add<DXApplication_WF_XAFBlazorModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(DXApplication_WF_XAF.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(DXApplication_WF_XAF.Module.BusinessObjects.ApplicationUserLoginInfo);
